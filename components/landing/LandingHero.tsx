        ...
        <div>
          ...
          >
            <Link
              href="/learn"
              prefetch
              className="group relative inline-flex items-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-l from-[#1B8354] to-[#25935F] px-7 py-3.5 text-sm font-black text-primary-foreground shadow-xl shadow-primary/25 transition-transform hover:scale-[1.02] active:scale-[0.98]"
            >
